...
function ensureStateInitialization() {
  if (!systemState) {
    log(
      'Creating default system state - this should not happen normally',
      'warn',
      'init'
    );
...
function initializeApp() {
  try {
    ...
    displayErrorNotification(
      'Application initialization failed, but we recovered basic functionality. Some features may not work correctly.'
    );
  }
}
...
export { systemState, socket, mouseClick, updateConnectionStatusUI };
