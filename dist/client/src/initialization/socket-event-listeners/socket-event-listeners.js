...
export const initializeSocketEventListeners = () => {
  ...
  socket.on('disconnect', () => {
    ...
    document.getElementById('chatbox').innerHTML +=
      '<div style="color: red; font-weight: bold">Disconnected from server</div>';
  ...
  socket.on('connect_error', (error) => {
    ...
    document.getElementById('chatbox').innerHTML +=
      '<div style="color: red; font-weight: bold">Failed to connect to server. Some multiplayer features may be limited.</div>';
  });
